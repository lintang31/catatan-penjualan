        ...
        <div class="p-5 mt-10">
            ...
            <div
                ...
                <div class="flex justify-between">
                    <h6 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Edit Barang</h6>
                </div>
                ...
                <div class="mt-5 text-left">
                    <!-- Form Input -->
                    <form action="<?php echo base_url('user/aksi_edit_barang'); ?>" method="post"
                        enctype="multipart/form-data">
                        <input type="hidden" name="id_produk"
                            value="<?php echo isset($manajemen_produk['id_produk']) ? $manajemen_produk['id_produk'] : ''; ?>">
                        <!-- Nama & Alamat Input -->
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="nama_barang" id="nama"
                                    ...
                                    value="<?php echo isset($manajemen_produk['nama_barang']) ? $manajemen_produk['nama_barang'] : ''; ?>" />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="jumlah_barang" id="nama"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " autocomplete="off" required
                                    value="<?php echo isset($manajemen_produk['jumlah_barang']) ? $manajemen_produk['jumlah_barang'] : ''; ?>" />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="keterangan_barang" id="nama"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " autocomplete="off" required
                                    value="<?php echo isset($manajemen_produk['keterangan_barang']) ? $manajemen_produk['keterangan_barang'] : ''; ?>" />
