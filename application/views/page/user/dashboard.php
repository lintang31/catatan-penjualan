        ...
        <div class="p-2 mt-5">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="<?= base_url('user/manajemen_produk') ?>"
                    class="relative w-full p-4 text-center bg-red-500 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <!-- Numeric value in the top-left corner -->
                    <span
                        class="absolute top-0 left-0 p-2 bg-white text-gray-700 dark:bg-gray-800 dark:text-gray-300 font-bold text-xl">
                        <?= $product_count ?>
                    </span>
                ...
                <a href="<?= base_url('user/history_jualan') ?>"
                    class="relative w-full p-4 text-center bg-green-500 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">

                    <!-- Numeric value in the top-left corner -->
                    <span
                        class="absolute top-0 left-0 p-2 bg-white text-gray-700 dark:bg-gray-800 dark:text-gray-300 font-bold text-xl">
                        <?= $history_count ?>
                        <!-- Replace with your variable containing the count -->
                    </span>
