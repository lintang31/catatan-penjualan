        ...
        <div class="p-5 mt-10">
            ...
            <div
                ...
                <div class="flex justify-between">
                    <h6 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Detail Jualan</h6>
                </div>
                ...
                <div class="mt-5 text-left">
                    <?php foreach ($proses_penjualan as $proses_penjualan): ?>
                    <!-- Form Input -->
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="nama_barang" id="nama_barang"
                                    value="<?php echo $proses_penjualan->nama_barang; ?>"
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="jumlah_barang" id="jumlah_barang"
                                    value="<?php echo $proses_penjualan->jumlah_barang; ?>"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " autocomplete="off" required readonly />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="harga_barang" id="harga_barang"
                                    value="<?php echo $proses_penjualan->harga_barang; ?>"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " autocomplete="off" required readonly />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="keterangan_barang" id="keterangan_barang"
                                    value="<?php echo $proses_penjualan->keterangan_barang; ?>"
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " autocomplete="off" required readonly />
